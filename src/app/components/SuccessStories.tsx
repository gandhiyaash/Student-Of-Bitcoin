                ...
                {story.image && (
                  <div className="w-full aspect-[4/3] rounded-xl overflow-hidden mb-8 shadow-sm">
                    <LazyImage
                      ...
                      className="w-full h-full object-cover object-top opacity-90 group-hover:opacity-100 transition-all duration-700 [image-rendering:auto] [backface-visibility:hidden] transform-gpu"
                    />
                  </div>
                )}
                <div className="mb-6">
